...
def test_user_registration_valid(page: Page,
    ...
    reg_page.open()
    reg_page.user_regisration(user_first_name="111111111", user_last_name="111111111", user_email="test6@mail.ru",
...
def test_user_registration_valid(page: Page,
                                 reg_page: RegistrationPage):
    reg_page.open()
    reg_page.user_regisration(user_first_name="11111111", user_last_name="11111111", user_email="1@1.1",
